...
begin
  if not Check then
    ...
    result := EccToDer(fContent.Signature);
end;
...
begin
  if not Check then
    ...
    result := DerToPem(EccToDer(fContent.Signature), pemCertificate);
end;
...
begin
  if fEcc <> nil then
    result := EccToDateTime(fEcc.Content.Signed.ValidityStart)
  else
    result := 0;
end;
...
begin
  if fEcc <> nil then
    result := EccToDateTime(fEcc.Content.Signed.ValidityEnd)
  else
    result := 0;
end;
