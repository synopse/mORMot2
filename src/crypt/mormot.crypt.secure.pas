...
type
  ...
  public
    ...
    function GenerateFromCsr(const CsrPem: RawUtf8;
      const Authority: ICryptCert; ExpireDays, ValidDays: integer;
      UsagesFilter: TCryptCertUsages): ICryptCert; virtual;
  ...
  public
    ...
    function GenerateFromCsr(const CsrPem: RawUtf8;
      const Authority: ICryptCert = nil; ExpireDays: integer = 365;
      ValidDays: integer = -1; UsagesFilter: TCryptCertUsages = []): ICryptCert; virtual;
...
function TCryptCertAlgo.GenerateFromCsr(const CsrPem: RawUtf8;
  const Authority: ICryptCert; ExpireDays, ValidDays: integer;
  UsagesFilter: TCryptCertUsages): ICryptCert;
begin
  result := New.
    GenerateFromCsr(CsrPem, Authority, ExpireDays, ValidDays, UsagesFilter);
end;
...
function TCryptCert.GenerateFromCsr(const CsrPem: RawUtf8;
  const Authority: ICryptCert; ExpireDays, ValidDays: integer;
  UsagesFilter: TCryptCertUsages): ICryptCert;
begin
  result := nil; // disabled by default
end;
