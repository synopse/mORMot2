...
type
  ...
  public
    ...
    // - supplied Csr PRM content should have been generated by a former
    // CreateSelfSignedCsr call
    // - implemented only as PKCS#10 by the X509/OpenSSL engine by now, in
    function GenerateFromCsr(const Csr: RawUtf8;
      const Authority: ICryptCert = nil; ExpireDays: integer = 365;
      ValidDays: integer = -1; UsagesFilter: TCryptCertUsages = [];
      Fields: PCryptCertFields = nil): ICryptCert; virtual;
...
function TCryptCertAlgo.GenerateFromCsr(const Csr: RawUtf8;
  const Authority: ICryptCert; ExpireDays, ValidDays: integer;
  UsagesFilter: TCryptCertUsages; Fields: PCryptCertFields): ICryptCert;
begin
  result := nil; // unsupported by default
end;
