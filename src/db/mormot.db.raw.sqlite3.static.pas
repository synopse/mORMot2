...
function _pthread_join(__th, __thread_return: pointer): integer;
  cdecl; external 'c' name 'pthread_join' + LIBC_SUFFIX;
function _pthread_mutex_trylock(__mutex:pointer): integer;
  cdecl; external 'c' name 'pthread_mutex_trylock' + LIBC_SUFFIX;
function _pthread_mutexattr_settype (__attr: pointer; Kind: integer): integer;
  cdecl; external 'c' name 'pthread_mutexattr_settype' + LIBC_SUFFIX;
function _pthread_mutexattr_init(__attr: pointer): integer;
  cdecl; external 'c' name 'pthread_mutexattr_init' + LIBC_SUFFIX;
function _pthread_create(__thread, __attr, __start_routine, __arg: pointer): integer;
  cdecl; external 'c' name 'pthread_create' + LIBC_SUFFIX;
function _pthread_mutexattr_destroy(__attr: pointer): integer;
  cdecl; external 'c' name 'pthread_mutexattr_destroy' + LIBC_SUFFIX;
function _pthread_mutex_init(__mutexn, __mutex_attr: pointer): integer;
  cdecl; external 'c' name 'pthread_mutex_init' + LIBC_SUFFIX;
function _pthread_mutex_destroy(__mutex: pointer): integer;
  cdecl; external 'c' name 'pthread_mutex_destroy' + LIBC_SUFFIX;
function _pthread_mutex_lock(__mutex: pointer): integer;
  cdecl; external 'c' name 'pthread_mutex_lock' + LIBC_SUFFIX;
function _pthread_mutex_unlock(__mutex: pointer): integer;
  cdecl; external 'c' name 'pthread_mutex_unlock' + LIBC_SUFFIX;
...
function __pthread_mutex_lock(__mutex: pointer): integer;
  cdecl; public name '_pthread_mutex_lock';
begin
  result := _pthread_mutex_lock(__mutex);
end;

function __pthread_mutex_unlock(__mutex: pointer): integer;
  cdecl; public name '_pthread_mutex_unlock';
begin
  result := _pthread_mutex_unlock(__mutex);
end;
