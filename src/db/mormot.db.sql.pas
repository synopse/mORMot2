...
type
  ...
  TOnTableCreate = function(Sender: TSqlDBConnectionProperties;
    const aTableName: RawUtf8; const aTable: TOrmClass;
    const Columns: TSqlDBColumnCreateDynArray;
  ...
  TOnTableAddColumn = function(Sender: TSqlDBConnectionProperties;
    const aTableName: RawUtf8; const aTable: TOrmClass;
    const Column: TSqlDBColumnCreate; const SQL: RawUtf8): boolean of object;
