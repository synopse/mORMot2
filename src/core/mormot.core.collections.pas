...
type
  ...
  // - as generated by TGenerics.NewKeyValue<TKey, TValue> main factory
  ...
  // - main factory is TGenerics.NewKeyValue<TKey, TValue> class function, which
  // returns a IKeyValue<> interface for reusing most class specializations: you
  // should NOT have to define a TSynKeyValueSpecialized<> anywhere
...
type
  ...
  // NewList<T>/NewKeyValue<TKey, TValue> methods of this class
  TGenerics = class
  protected
