...
type
  ...
  public
    ...
    // - default is 1 MB
    property SeedAfterBytes: integer
    ...
    property SeedPBKDF2Rounds: cardinal
      read fSeedPBKDF2Rounds;
...
begin
  ...
  try
    ...
    begin
      ...
      inc(P);
      if (len > $7f) or
         (length(Data) - len <> P - pointer(Data)) then
...
begin
  FillRandom(block.b);
  result := (block.L * max) shr 32; // no needt o XOR with block.H
end;
