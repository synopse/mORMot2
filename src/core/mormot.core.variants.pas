...
begin
  ...
  if (Dest <> nil) and
    ...
    exit;
  // circumvent https://bugs.freepascal.org/view.php?id=38653 for FPC,
  // avoid unneeded conversion to varOleString for Delphi, and
  // implement direct IntGet/IntSet call for TSynInvokeableVariantType
