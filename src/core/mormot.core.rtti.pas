...
type
  ...
  // rkObject are stored as varAny pointer to the field value (varNull if no
  // address) and RttiCustom to the corresponding RTTI
...
begin
  ...
  begin
    ...
    else if (v1.Data.VType <> v2.Data.VType) or
            (v1.RttiCustom <> v2.RttiCustom) then
