...
var
  ...
  ECIES_AES: array[ecaFIRST .. ecaLAST] of TAesAbstractClass = (
    TAesCfb, TAesCbc, TAesOfb, TAesCtrNist, TAesCfb, TAesCbc, TAesOfb, TAesCtrNist,
    TAesCfb, TAesCbc, TAesOfb, TAesCtrNist, TAesCfb, TAesCbc, TAesOfb, TAesCtrNist,
    TAesGcm, TAesGcm, TAesGcm, TAesGcm);
  ...
  try
    ...
    begin
      ...
      case ECIES_AESSIZE[Algo] of
        128:
          enc := ECIES_AES[Algo].MacEncrypt(dec, aeskey.Lo, {encrypt=}true);
        256:
          enc := ECIES_AES[Algo].MacEncrypt(dec, aeskey.b, true);
      end;
  ...
  try
    ...
    begin
      ...
      case ECIES_AESSIZE[head.Algo] of
        128:
          enc := ECIES_AES[head.Algo].MacEncrypt(dec{%H-}, aeskey.Lo, {encrypt=}false);
        256:
          enc := ECIES_AES[head.Algo].MacEncrypt(dec, aeskey.b, false);
      end;
      if length(enc) < SizeOf(TMacAndCryptData) then
