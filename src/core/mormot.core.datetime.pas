...
procedure TimeToIso8601PChar(P: PUTF8Char; Expanded: boolean;
  H, M, S, MS: PtrUInt; FirstChar: AnsiChar; WithMS: boolean);
...
const
  ISO8601_LEN: array[boolean, boolean] of integer = ((15, 14), (19, 18));
var
...
begin
  ...
  begin
    ...
    TimeToIso8601PChar(Dest, Expanded, (lo shr (6 + 6)) and 31, (lo shr 6) and 63, lo and 63, 0, FirstTimeChar);
    if Expanded then
      result := 9
    else
      result := 7;
