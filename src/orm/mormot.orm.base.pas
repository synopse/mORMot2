...
type
  ...
  // "POST"/"SIMPLE" encodings - for backward compatibility, or if client and
  // server TOrmModel tables or fields do not match
  TRestBatchOption = (
    boInsertOrIgnore,
    boInsertOrReplace,
    boExtendedJson,
...
const
  ...
  BATCH_SIMPLE = [encSimple, encPostHex, encPostHexID];
...
function TOrmPropertiesAbstract.SaveFieldsFromJsonArray(var P: PUtf8Char; const Bits: TFieldBits;
  ID: TID; EndOfObject: PAnsiChar; ExtendedJson, FirstIsID: boolean): RawUtf8;
var
  i: PtrInt;
  W: TJsonSerializer;
