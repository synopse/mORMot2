...
type
  ...
  TOnEngineCreate = function(Sender: TRestStorageExternal;
  ...
  // - the default SQL as generated by the ORM is supplied as reference
  // - should return TRUE if the table has been created, FALSE if not
  TOnEngineAddColumn = function(Sender: TRestStorageExternal;
  ...
  TOnEngineCreateMultiIndex = function(Sender: TRestStorageExternal;
  ...
  protected
    ...
    fOnEngineCreate: TOnEngineCreate;
    fOnEngineAddColumn: TOnEngineAddColumn;
    fOnEngineCreateMultiIndex: TOnEngineCreateMultiIndex;
  ...
  public
    ...
    /// allow to customize the creation of a table
    // - may be used e.g. to generate a partitioned table on PostgreSQL
    property OnEngineCreate: TOnEngineCreate
      read fOnEngineCreate write fOnEngineCreate;
    /// allow to customize the creation of a table
    // - may be used e.g. to generate a partitioned table on PostgreSQL
    property OnEngineAddColumn: TOnEngineAddColumn
      read fOnEngineAddColumn write fOnEngineAddColumn;
    /// allow to customize the creation of an index
    property OnEngineCreateMultiIndex: TOnEngineCreateMultiIndex
      read fOnEngineCreateMultiIndex write fOnEngineCreateMultiIndex;
  published
...
begin
  ...
  if not (rpmNoCreateMissingTable in options) then
    ...
    begin
      ...
      if Assigned(fOnEngineCreate) then
        TableCreated := fOnEngineCreate(self, CreateColumns, SQL)
      else if SQL <> '' then
...
begin
  ...
  if Assigned(fOnEngineCreateMultiIndex) then
    result := fOnEngineCreateMultiIndex(
      self, FieldNames, Unique, IndexName, SQL)
  else if SQL <> '' then
