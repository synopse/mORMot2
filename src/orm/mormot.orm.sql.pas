...
type
  ...
  /// event handler called to customize TRestStorageExternal.CreateSqlMultiIndex
  ...
  TOnEngineCreateSqlMultiIndex = function(Sender: TRestStorageExternal;
    Table: TOrmClass; const FieldNames: array of RawUtf8; Unique: boolean;
    IndexName: RawUtf8; const SQL: RawUtf8): boolean;
  ...
  protected
    ...
    fOnEngineCreateSqlMultiIndex: TOnEngineCreateSqlMultiIndex;
  ...
  public
    ...
    property OnEngineCreateSqlMultiIndex: TOnEngineCreateSqlMultiIndex
      read fOnEngineCreateSqlMultiIndex write fOnEngineCreateSqlMultiIndex;
  published
...
begin
  ...
  if Assigned(fOnEngineCreateSqlMultiIndex) then
    result := fOnEngineCreateSqlMultiIndex(
      self, Table, FieldNames, Unique, IndexName, SQL)
  else if SQL <> '' then
