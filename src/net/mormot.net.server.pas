...
type
  ...
  // optimized .mhm file encoding, for efficient search on the whole dataset
  /// - support up to 10,485,760 metrics per instance (see HTTPMETRICS_MAXCOUNT)
  ...
  public
    ...
    procedure SaveToFile(const Dest: TFileName; Algo: TAlgoCompress = nil);
