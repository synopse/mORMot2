...
The plain `/*` URI are using the ORM, and the `/raw*` URI have a direct access to the DB layer without the ORM, and tuned SQL, so are faster.
...
wrk -c 256 -t 3 -d 5 http://localhost:8080/queries?queries=20
wrk -c 256 -t 3 -d 5 http://localhost:8080/cached-queries?count=100
wrk -c 256 -t 3 -d 5 http://localhost:8080/updates?queries=20
wrk -c 256 -t 3 -d 5 http://localhost:8080/fortunes
wrk -c 256 -t 3 -d 5 http://localhost:8080/rawdb
wrk -c 256 -t 3 -d 5 http://localhost:8080/rawqueries
wrk -c 256 -t 3 -d 5 http://localhost:8080/rawqueries?queries=20
wrk -c 256 -t 3 -d 5 http://localhost:8080/rawcached?count=100
wrk -c 256 -t 3 -d 5 http://localhost:8080/rawupdates?queries=20
wrk -c 256 -t 3 -d 5 http://localhost:8080/rawfortunes
```
...
The plain `/cached-queries` uses the regular ORM cache, and `/rawcached` uses a simple in-memory array cache.
