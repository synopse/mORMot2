...
// - same thin entry point as ..\cli_client.pas used by the shell scripts:
...
uses
  ...
  AppTaskManagerClient in '..\AppTaskManagerClient.pas',
  {$ifdef LOCAL_MODE}
  ...
  AppTaskManagerClientLocal in '..\AppTaskManagerClientLocal.pas',
  {$else}
  AppTaskManagerClientRemote in '..\AppTaskManagerClientRemote.pas',
  {$endif}
  cli_client_core in '..\cli_client_core.pas';
